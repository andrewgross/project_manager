...
def create_project_dir(project_name, git_repo=None, gpu_count=None, image_name="ubuntu-cuda:v6"):
...
if __name__ == "__main__":
    ...
    parser.add_argument("--image-name", type=str, default="ubuntu-cuda:v6", help="The local Docker image to use") # removed version tag from default image
